...
######## RUN this program: THEANO_FLAGS=mode=FAST_RUN,device=cpu,floatX=float32 python ../model/bootstrapping_CNN.py ##########
...
if __name__ == "__main__":
    ...
    other_ratio = 10 # 10 times other of after and before
